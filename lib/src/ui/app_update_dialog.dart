...
class AppUpdateDialog extends StatefulWidget {
  ...
  /// 自定义更新信息头部构建器
  final Widget Function(BuildContext, AppUpdateInfo)? headerBuilder;
  
  /// 自定义更新内容构建器
  final Widget Function(BuildContext, AppUpdateInfo)? contentBuilder;
  
  /// 自定义按钮构建器
  final Widget Function(BuildContext, AppUpdateInfo, AppUpdateStatus)? actionsBuilder;
  
  /// 自定义进度指示器构建器
  final Widget Function(BuildContext, AppUpdateProgress)? progressBuilder;
...
class _AppUpdateDialogState extends State<AppUpdateDialog> {
  ...
  Widget _buildProgressArea(BuildContext context, ThemeData theme) {
    ...
    // 显示错误信息
    if (status == AppUpdateStatus.error && _error != null) {
      return Padding(
